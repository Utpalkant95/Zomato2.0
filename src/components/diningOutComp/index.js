...
let Collection=[
  ...
  {
    id:"5",
    headline:"12 Premium Coffee Shops",
    places:"12 Places",
    icon:"bx bxs-right-arrow",
    img:"https://b.zmtcdn.com/data/collections/d04069dbde1a5e6283328d6aeb296540_1679126611.jpg"
  },
  {
    id:"6",
    headline:"21 Romantic Dining Places",
    places:"21 Places",
    icon:"bx bxs-right-arrow",
    img:"https://b.zmtcdn.com/data/collections/8dd5adbf91d78c8d11796c6b230539ef_1674568824.jpg"
  },
  {
    id:"7",
    headline:"9 Unique Dining Experien",
    places:"9 Places",
    icon:"bx bxs-right-arrow",
    img:"https://b.zmtcdn.com/data/collections/2deab8e9f06ff125e80f5cc09f11e4d7_1674569132.jpg"
  },
  {
    id:"8",
    headline:"18 Blissful Breakfast Places",
    places:"18 Places",
    icon:"bx bxs-right-arrow",
    img:"https://b.zmtcdn.com/data/collections/633c8675a805dce153ee5f16ea9d9fd5_1679129823.jpg"
  }
]
...
const DiningOutComp = () => {
  return (
    <div className='max-w-6xl mx-auto'>
      <Collections heading="Collections" title="Explore curated lists of top restaurants, cafes, pubs, and bars in Delhi NCR, Based on trends" tagline="All collections in Delhi NCR" icon="bx bxs-right-arrow" collection={Collection} adjTop="-mt-[5px]" adjHeading="mb-[10px]" className="gap-8 overflow-scroll overflow-y-hidden hide-scrollbar" h="h-[320px]" w="w-[260px]"/>

      <FilterComp filters={filters} className="mt-5 -ml-4"/>

      <BestFoodComp title="Best Dining Restaurants near you in Mukherjee Nagar" bestFood={bestFood} widht="ml-2" alignTop="-mt-[15px]" alignLeft="-ml-[328px]" adjkm="bottom-[80px]"/>
